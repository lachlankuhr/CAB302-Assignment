...
public class RefrigeratedTruck extends Truck {
	...
	/**
	 * Constructor for the refrigerated truck. Uses super constructor, setting the correct manifest tag and maximum cargo amounts.
	 * @author Atrey Gajjar
	 */
	...
	/**
	 * Calculates the cost of delivery for a Refrigerated Truck. 
